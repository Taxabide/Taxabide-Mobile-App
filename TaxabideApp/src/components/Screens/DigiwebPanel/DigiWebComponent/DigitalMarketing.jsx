...
const DigitalMarketing = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!userId) {
      Alert.alert('Login Required', 'Please log in to submit this form', [
        {text: 'Cancel', style: 'cancel'},
        {
          text: 'Login',
          onPress: () =>
            navigation.navigate('SignIn', {returnTo: 'DigitalMarketing'}),
        },
      ]);
      return;
    }
    ...
    try {
      ...
      try {
        // Using the correct endpoint for digital marketing
        const apiUrl = `https://taxabide.in/api/tdws-digital-marketing-api.php?uid=${userId}&user_id=${userId}&t_d_user_id=${userId}`;
                ...
                {filteredClients.map(client => (
                  <TouchableOpacity
                    ...
                    <Text style={styles.dropdownItemText}>
                      {client.c_name}{' '}
                      {client.c_email ? `, Email: ${client.c_email}` : ''}
                    </Text>
                  </TouchableOpacity>
                ))}
              </ScrollView>
      ...
      <ProfileNavbar navigation={navigation} />
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.container}>
            ...
            Tulyarth DigiWeb Services - Digital Marketing
            </Text>
          ...
          <Text style={styles.label}>Choose Additional Services</Text>
          <ServiceCheckbox
            service="SocialMedia"
            label="Social Media Management"
          />
          <ServiceCheckbox service="SEO" label="SEO Optimization" />
          <ServiceCheckbox service="PPC" label="PPC Campaign Management" />
          <ServiceCheckbox
            service="ContentMarketing"
            label="Content Strategy & Creation"
          />
          <ServiceCheckbox service="EmailMarketing" label="Email Campaigns" />

          <Text style={styles.label}>Any Questions or Requirements?</Text>
            <TextInput
                ...
                if (userId) {
                  ...
                  Alert.alert(
                    ...
                    [
                      ...
                      {
                        text: 'Login', 
                        onPress: () => navigation.navigate('SignIn', {returnTo: 'DigitalMarketing'})
                      }
                    ]
                  );
                }
