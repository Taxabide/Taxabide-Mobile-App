...
const BusinessLoanAgainstProperty = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.formCard}>
        <Text style={styles.title}>Loan Against Property (New)</Text>
          ...
          <View style={styles.documentBox}>
           ...
           {/* Property Documents Section */}
                    <View style={styles.documentBox}>
                      ...
                      {renderFileInput('Completion Certificate in case of ready flat/Old Flat/House ( if applicable)', 'completionCert')}
                      {renderFileInput('Occupancy Certificate (OC) - in case of ready/old Flat/House (if applicable)', 'occupancyCert')}
                      {renderFileInput('Latest Tax Paid Receipt (property) - in case of Old Flat/House', 'taxReceipt')}
                      {renderFileInput('Society Registration Certificate - in case of ready Old Flat/House (if applicable)', 'societyRegCert')}
                      {renderFileInput('Chain of old Agreements (resale flat) - in case of Old Flat/House', 'chainOfAgreements')}
                      ...
                      {renderFileInput('Permission letter from appropriate authority (if applicable)', 'permissionLetter')}
                    </View>
...
export default BusinessLoanAgainstProperty;