...
export default function SalariedCarLoan({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Car Loan Application</Text>
      </View>
        ...
        >
          <View style={styles.formContainer}>
            ...
            <View style={styles.formCard}>
              <Text style={styles.title}>Car Loan (New)</Text>
              ...
              <View style={{ marginTop: 30 }}>
                ...
                {/* For CRPF/Army/Navy Employees only Section */}
                          <View style={styles.documentBox}>
                            <Text style={styles.documentTitle}>For CRPF/Army/Navy Employees only</Text>
                            {renderFileInput('Office ID card (In case of CRPF/Army/Navy)', 'officeIDCard')}
                            {renderFileInput('Service Certificate (In case of CRPF/Army/Navy)', 'serviceCertificate')}
                          </View>
