...
export default function SalariedPersonalLoan({ navigation }) {
  ...
  // Document states with optimized structure
    ...
    try {
      ...
      if (!result.canceled && result.assets && result.assets.length > 0) {
        if (allowMultiple) {
          ...
          setDocuments(prev => ({
            ...prev,
            [documentKey]: { uri: asset.uri, name: fileName },
          }));
        }
      }
    } catch (error) {
...
const validateForm = () => {
  ...
  if (!formData.loanAmount.trim() || !formData.firstName.trim() || !formData.lastName.trim() || 
      !formData.mobile.trim() || !formData.dob || !formData.email.trim() || !formData.pan.trim() || 
      !formData.residencePincode.trim() || !formData.pincode.trim()) {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.formCard}>
        ...
        {showDobPicker && (
          <DateTimePicker
            ...
            onChange={(event, selectedDate) => {
              ...
              if (event.type !== 'dismissed') setFormData({ ...formData, dob: selectedDate });
            }}
          />
        )}
        ...
        <TextInput
          ...
          onChangeText={(text) => setFormData({ ...formData, residencePincode: text })}
          maxLength={6}
        />
        ...
        <View style={{ marginTop: 30 }}>
          ...
          <View style={styles.documentBox}>
           ...
           {/* Business Ownership Proof */}
            ...
            {renderFileInput('Panchayati online License', 'panchayatiLicens')}
